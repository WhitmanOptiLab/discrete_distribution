//this code comes from https://github.com/Daniel-Allendorf/proposal-array/blob/main/include/sampling/DynamicProposalArray.hpp 
#pragma once
#include <cassert>
#include <functional>
#include <random>
...
public:
    ...
    DynamicProposalArray(InputIt first, InputIt last): DynamicProposalArray(weightsToElements(first,last)){
    }
...
private:
    ...
    template<class InputIt>
    std::vector<double> weightsToElements(InputIt start, InputIt end){
