#ifndef SF_JUMP_BAD_BRANCHES
#define SF_JUMP_BAD_BRANCHES
////////////////////////////////IMPORTANT/////////////////////////////////////
...
namespace stochastic {
    ...
    protected complete_tree<I, Real >
  {
    ...
    public:
      ...
      using index_type = I;
      using This = sf_jump_bad_branches<index_type, precision>;
      ...
      sf_jump_bad_branches() = delete;

      template<typename InputIt>
      sf_jump_bad_branches(InputIt first, InputIt last) :
          BaseTree() 
      {
      ...
      sf_jump_bad_branches(sf_jump_bad_branches const&) = default;

      sf_jump_bad_branches(sf_jump_bad_branches &&) = default;

      sf_jump_bad_branches& operator=(sf_jump_bad_branches const&) = default;

      sf_jump_bad_branches& operator=(sf_jump_bad_branches &&) = default;

      ~sf_jump_bad_branches() = default;
    ...
    private:
      ...
      sf_jump_bad_branches const& const_this() const {
