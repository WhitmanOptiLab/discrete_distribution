...
echo "uniform_4_child_leafsum, uniform_8_child_leafsum, uniform_16_child_leafsum, uniform_32_child_leafsum, uniform_64_child_leafsum, uniform_128_child_leafsum, uniform_incremental_leafsum, uniform_leafsum" > resultsC1_$2.csv
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0, $result1, $result2, $result3, $result4, $result5, $result6, $result7" >> resultsC1_$2.csv
...
echo "$average0, $average1, $average2, $average3, $average4, $average5, $average6, $average7" >> resultsC1_$2.csv
