...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree<int>"          "-DWEIGHTNUM=$2" -o test2 normal_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree_split<int>"    "-DWEIGHTNUM=$2" -o test3 normal_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=sideways_fenwick_selector<int>" "-DWEIGHTNUM=$2" -o test4 normal_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=low_storage_selector<int>" "-DWEIGHTNUM=$2" -o test5 normal_changing_multi.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=nonuniform_int_distribution<int>"       "-DWEIGHTNUM=$2" -o test6 uniform_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=fast_random_selector<int>"             "-DWEIGHTNUM=$2" -o test7 uniform_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree<int>"          "-DWEIGHTNUM=$2" -o test8 uniform_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree_split<int>"    "-DWEIGHTNUM=$2" -o test9 uniform_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=sideways_fenwick_selector<int>" "-DWEIGHTNUM=$2" -o test10 uniform_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=low_storage_selector<int>"                "-DWEIGHTNUM=$2" -o test11 uniform_changing_multi.cpp

# Weibull distribution changing_multi weight tests
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=nonuniform_int_distribution<int>"       "-DWEIGHTNUM=$2" -o test12 weibull_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=fast_random_selector<int>"             "-DWEIGHTNUM=$2" -o test13 weibull_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree<int>"          "-DWEIGHTNUM=$2" -o test14 weibull_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=leaf_sum_tree_split<int>"    "-DWEIGHTNUM=$2" -o test15 weibull_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=sideways_fenwick_selector<int>" "-DWEIGHTNUM=$2" -o test16 weibull_changing_multi.cpp
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=low_storage_selector<int>"                "-DWEIGHTNUM=$2" -o test17 weibull_changing_multi.cpp
