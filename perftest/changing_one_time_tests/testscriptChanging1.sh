...
echo "normal_changing_wrs, normal_changing_leafsum, normal_changing_leaf_sum_split, normal_changing_sideways_fenwick, uniform_changing_wrs, uniform_changing_leafsum, uniform_changing_leaf_sum_split, uniform_changing_sideways_fenwick, weibull_changing_wrs, weibull_changing_leafsum, weibull_changing_leaf_sum_split, weibull_changing_sideways_fenwick" > resultsC1_$2.csv
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0, $result2, $result3, $result4, $result6, $result8, $result9, $result10, $result12, $result14, $result15, $result16" >> resultsC1_$2.csv
...
echo "$average0, $average2, $average3, $average4, $average6, $average8, $average9, $average10, $average12, $average14, $average15, $average16" >> resultsC1_$2.csv
