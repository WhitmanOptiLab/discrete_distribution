...
echo "normal_changing_wrs, normal_changing_heap, normal_changing_leafsum, normal_changing_leaf_sum_split, normal_changing_sideways_fenwick, normal_changing_weightsum, uniform_changing_wrs, uniform_changing_heap, uniform_changing_leafsum, uniform_changing_leaf_sum_split, uniform_changing_sideways_fenwick, uniform_changing_weightsum, weibull_changing_wrs, weibull_changing_heap, weibull_changing_leafsum, weibull_changing_leaf_sum_split, weibull_changing_sideways_fenwick, weibull_changing_weightsum" > resultsC1_$2.csv

# Normal distribution changing weight tests
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=nonuniform_int_distribution<>"       "-DWEIGHTNUM=$2" -o test0 normal_changing.cpp
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test1 normal_changing.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>" "-DWEIGHTNUM=$2" -o test4 normal_changing.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=nonuniform_int_distribution<>"       "-DWEIGHTNUM=$2" -o test6 uniform_changing.cpp
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test7 uniform_changing.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>" "-DWEIGHTNUM=$2" -o test10 uniform_changing.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=nonuniform_int_distribution<>"       "-DWEIGHTNUM=$2" -o test12 weibull_changing.cpp
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test13 weibull_changing.cpp
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0, $result1, $result2, $result3, $result4, $result5, $result6, $result7, $result8, $result9, $result10, $result11, $result12, $result13, $result14, $result15, $result16, $result17" >> resultsC1_$2.csv
...
echo "$average0, $average1, $average2, $average3, $average4, $average5, $average6, $average7, $average8, $average9, $average10, $average11, $average12, $average13, $average14, $average15, $average16, $average17" >> resultsC1_$2.csv
