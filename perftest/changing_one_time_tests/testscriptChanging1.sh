...
echo "normal_changing_SF_bitcast, normal_changing_SF_itercount, normal_changing_leafsum, normal_changing_leaf_sum_split, normal_changing_sf_jump, uniform_changing_SF_bitcast, uniform_changing_SF_itercount, uniform_changing_leafsum, uniform_changing_leaf_sum_split, uniform_changing_sf_jump, weibull_changing_SF_bitcast, weibull_changing_SF_itercount, weibull_changing_leafsum, weibull_changing_leaf_sum_split, weibull_changing_SF_jump" > resultsC1_$2.csv
