...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>"                "-DWEIGHTNUM=$2" -o test11 uniform_changing.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>"                "-DWEIGHTNUM=$2" -o test17 weibull_changing.cpp
