...
echo "SF_bitcast, LS_incremental, LS, LS_split, SF_jump" > resultsAddRemove_$2.csv
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0, $result1, $result2, $result3, $result4" >> resultsAddRemove_$2.csv
...
echo "$average0, $average1, $average2, $average3, $average4" >> resultsAddRemove_$2.csv
