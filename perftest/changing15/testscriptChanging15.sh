...
echo "normal_changing_multi_incremental_LS, normal_changing_multi_sf_jump, normal_wrs_less_storage, uniform_changing_multi_incremental_LS, uniform_changing_multi_sf_jump, uniform_wrs_less_storage, weibull_changing_multi_incremental_LS, weibull_changing_multi_sf_jump, weibull_wrs_less_storage" > resultsC15_$2.csv
...
for ((i=1; i<=$1; i++)); do
    ...
    echo "$result0, $result1, $result2, $result3, $result4, $result5, $result6, $result7, $result8" >> resultsC15_$2.csv
...
echo "$average0, $average1, $average2, $average3, $average4, $average5, $average6, $average7, $average8" >> resultsC15_$2.csv
