...
# 'g++ -std=c++20 -I../../../lib -O3 "-DWRSLIB=incremental_exponential_zero_weight<>" "-DWEIGHTNUM=${weightNums[$i]}" -o test$i backAndForth.cpp'
'g++ -std=c++20 -I../../../lib -O3 "-DWRSLIB=incremental_exponential_no_resize<>" "-DWEIGHTNUM=${weightNums[$i]}" -o test$i backAndForth.cpp'
 'g++ -std=c++20 -I../../../lib -O3 "-DWRSLIB=alex_version_better_memory<>" "-DWEIGHTNUM=${weightNums[$i]}" -o test$i backAndForth.cpp'
...
names=(
  ...
  # backAndForth_incrementalZeroWeightKary
  backAndForth_incrementalNoResizeKary
  backAndForth_alexVersionBetterMemory
)
