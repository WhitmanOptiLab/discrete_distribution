...
echo "normal_static_leafsum, normal_static_exponential_leaf_sum_8, normal_static_exponential_leaf_sum_32, normal_changing_leafsum, normal_changing_exponential_leaf_sum_8, normal_changing_exponential_leaf_sum_32, uniform_static_leafsum, uniform_static_exponential_leaf_sum_8, uniform_static_exponential_leaf_sum_32, uniform_changing_leafsum, uniform_changing_exponential_leaf_sum_8, uniform_changing_exponential_leaf_sum_32, weibull_static_leafsum, weibull_static_exponential_leaf_sum_8, weibull_static_exponential_leaf_sum_32, weibull_changing_leafsum, weibull_changing_exponential_leaf_sum_8, weibull_changing_exponential_leaf_sum_32"  > results_$2.csv
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test2 normal_static.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test5 normal_changing.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test8 uniform_static.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test11 uniform_changing.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test14 weibull_static.cpp
...
g++ -std=c++20 -I../lib -O3 "-DWRSLIB=exponential_leaf_sum_tree<size_t,double,32>" "-DWEIGHTNUM=$2" -o test17 weibull_changing.cpp
