...
echo "Number of Selections: $2" # second argument is number of weights in data structure
...
# g++ -I../lib -O3 "-DWRSLIB=std::discrete_distribution<int>" "-DSELECTNUM=$2" -o test2 normal_static.cpp
...
# g++ -I../lib -O3 "-DWRSLIB=nonuniform_int_distribution<int>" "-DSELECTNUM=$2" -o test5 uniform_static.cpp
# g++ -I../lib -O3 "-DWRSLIB=fast_random_selector<int>" "-DSELECTNUM=$2" -o test6 uniform_static.cpp
# g++ -I../lib -O3 "-DWRSLIB=std::discrete_distribution<int>" "-DSELECTNUM=$2" -o test7 uniform_static.cpp

# # Uniform distribution changing weight tests
# g++ -I../lib -O3 "-DWRSLIB=nonuniform_int_distribution<int>" "-DSELECTNUM=$2" -o test8 uniform_changing.cpp
# g++ -I../lib -O3 "-DWRSLIB=fast_random_selector<int>" "-DSELECTNUM=$2" -o test9 uniform_changing.cpp
