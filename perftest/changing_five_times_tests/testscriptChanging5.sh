...
echo "normal_changing_multi_SF_bitcast, normal_changing_multi_SF_itercount, normal_changing_multi_leafsum, normal_changing_multi_leaf_sum_split, normal_changing_multi_sf_jump, uniform_changing_multi_SF_bitcast, uniform_changing_multi_SF_itercount, uniform_changing_multi_leafsum, uniform_changing_multi_leaf_sum_split, uniform_changing_multi_sf_jump, weibull_changing_multi_SF_bitcast, weibull_changing_multi_SF_itercount, weibull_changing_multi_leafsum, weibull_changing_multi_leaf_sum_split, weibull_changing_multi_SF_jump" > resultsC5_$2.csv
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>"             "-DWEIGHTNUM=$2" -o test1 normal_changing_multi.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=sideways_fenwick_selector<>"             "-DWEIGHTNUM=$2" -o test13 weibull_changing_multi.cpp
