...
echo "normal_changing_multi_wrs, normal_changing_multi_heap, normal_changing_multi_leafsum, normal_changing_multi_leaf_sum_split, normal_changing_multi_sideways_fenwick, normal_changing_multi_weightsum, uniform_changing_multi_wrs, uniform_changing_multi_heap, uniform_changing_multi_leafsum, uniform_changing_multi_leaf_sum_split, uniform_changing_multi_sideways_fenwick, uniform_changing_multi_weightsum, weibull_changing_multi_wrs, weibull_changing_multi_heap, weibull_changing_multi_leafsum, weibull_changing_multi_leaf_sum_split, weibull_changing_multi_sideways_fenwick, weibull_changing_multi_weightsum" > resultsC5_$2.csv
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test1 normal_changing_multi.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test7 uniform_changing_multi.cpp
...
g++ -std=c++20 -I../../lib -O3 "-DWRSLIB=fast_random_selector<>"             "-DWEIGHTNUM=$2" -o test13 weibull_changing_multi.cpp
